...
# min_blue, min_green, min_red = 28, 187, 184
# max_blue, max_green, max_red = 101, 255, 255
def do_nothing(x):
    pass
...
while True:
    ...
    # cv2.imshow('Binary frame with Mask', mask min_blue = cv2.getTrackbarPos('min_blue', 'Track Bars')
    min_green = cv2.getTrackbarPos('min_green', 'Track Bars')
    min_red = cv2.getTrackbarPos('min_red', 'Track Bars')
